...
import { GameResultByTeam } from "./types/Game";
...
export type AppRouteProp<T extends keyof NavigationRoutes> = RouteProp<
  NavigationRoutes,
  T
>;
...
export type AppNavigationProp<T extends keyof NavigationRoutes> =
  NativeStackScreenProps<NavigationRoutes, T>;
