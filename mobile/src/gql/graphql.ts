...
export type GameFragmentFragment = { __typename?: 'Game', id: any, duration: number, gameEnded: boolean, name: string, teamGameCollection?: { __typename?: 'TeamGameConnection', edges: Array<{ __typename?: 'TeamGameEdge', node: (
